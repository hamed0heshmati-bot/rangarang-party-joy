...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "رنگارنگ — فروشگاه آنلاین لوازم جشن و کادو" },
      { property: "og:description", content: "خرید آنلاین لوازم جشن، تولد، کادوهای خاص و وسایل فانتزی با ارسال سریع." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "رنگارنگ — فروشگاه آنلاین لوازم جشن و کادو" },
      { name: "twitter:description", content: "خرید آنلاین لوازم جشن، تولد، کادوهای خاص و وسایل فانتزی با ارسال سریع." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1116efec-99b0-42ec-945a-93c71a8468a9/id-preview-c7b139cd--e98d5321-a1df-49db-bd25-30d7af742769.lovable.app-1780664926603.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1116efec-99b0-42ec-945a-93c71a8468a9/id-preview-c7b139cd--e98d5321-a1df-49db-bd25-30d7af742769.lovable.app-1780664926603.png" },
